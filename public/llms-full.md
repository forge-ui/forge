...
Forge UI Kit is a component library for building operational admin systems with React 19, Next.js 16, Tailwind v4, and solar-icon-set. The package is `@forge-ui-official/core@0.1.10`.
