            ...
            <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[400px]">
              ...
              <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full">
                <div className="content-stretch flex flex-[1_0_0] flex-col gap-[6px] items-start min-h-px min-w-px relative">
                  <p className="font-medium leading-5 relative text-fg-grey-700 text-sm tracking-fg">
                    Name
                  </p>
                  <input
                    type="text"
              ...
              <div className="content-stretch flex gap-[8px] items-start overflow-clip relative shrink-0 w-full">
                <div className="relative shrink-0 size-[20px] cursor-pointer">
                  <input type="checkbox" className="absolute inset-0 opacity-0 cursor-pointer z-10" />
                  <div className="absolute bg-white border-2 border-fg-grey-500 border-solid inset-0 rounded-[6px]" />
                </div>
                <p className="flex-[1_0_0] font-semibold min-h-px min-w-px relative text-fg-grey-700">
                  <span className="leading-5 text-sm tracking-fg">I agree to all the </span>
                  <span className="leading-5 text-fg-violet text-sm tracking-fg cursor-pointer hover:underline">Terms</span>
                  <span className="leading-5 text-sm tracking-fg"> & </span>
                  <span className="leading-5 text-fg-violet text-sm tracking-fg cursor-pointer hover:underline">Privacy Policy</span>
                </p>
              </div>
