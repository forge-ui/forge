        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 [&>*]:!w-full">
          <div className="rounded-card bg-fg-violet text-white p-5 flex flex-col gap-4 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="mt-1 h-1.5 w-full rounded-full bg-fg-violet-800/50 overflow-hidden">
          ...
          <div className="rounded-3xl bg-white border border-fg-grey-200 p-6 flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-2 pt-2 border-t border-fg-grey-200">
              <div className="flex flex-col items-center gap-1">
                ...
                <span className="text-lg font-semibold text-fg-black inline-flex items-center gap-1">44.2 <span className="text-fg-green text-xs">▲</span></span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <span className="text-xs text-fg-grey-500">Customer</span>
                <span className="text-lg font-semibold text-fg-black inline-flex items-center gap-1">11.2k <span className="text-fg-green text-xs">▲</span></span>
              </div>
            </div>
          </div>
        </div>
